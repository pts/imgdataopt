...
imgdataopt.xstatic: imgdataopt.c $(ZLIB_HEADERS) $(ZLIB_SRCS)
	xstatic $(CC) -Wl,--gc-sections -ffunction-sections -fdata-sections -Izlib_src -DNO_VIZ -ansi -pedantic -s -O2 -W -Wall -Wextra $(CFLAGS) -o imgdataopt.xstatic imgdataopt.c zlib_src/zall.c
# Using -O3 so that it will be faster in pdfsizeopt.
imgdataopt.xstatico3: imgdataopt.c $(ZLIB_HEADERS) $(ZLIB_SRCS)
	xstatic $(CC) -Wl,--gc-sections -ffunction-sections -fdata-sections -Izlib_src -DNO_VIZ -ansi -pedantic -s -O3 -W -Wall -Wextra $(CFLAGS) -o imgdataopt.xstatico3 imgdataopt.c zlib_src/zall.c
imgdataopt.exe: imgdataopt.c $(ZLIB_HEADERS) $(ZLIB_SRCS)
	$(CC_MINGW) -Wl,--gc-sections -ffunction-sections -fdata-sections -Izlib_src -DNO_VIZ -ansi -pedantic -s -O2 -W -Wall -Wextra $(CFLAGS) -o imgdataopt.exe imgdataopt.c zlib_src/zall.c
...
imgdataopt.darwinc32: imgdataopt.c $(ZLIB_HEADERS) $(ZLIB_SRCS)
	$(DOCKER_CROSSBUILD) /usr/osxcross/bin/o32-clang -mmacosx-version-min=10.5 -Wl,-dead_strip -ffunction-sections -fdata-sections -lSystem -lcrt1.10.5.o -nostdlib -Izlib_src -DNO_VIZ -DNO_COMBINE64 -ansi -pedantic -O2 -W -Wall -Wextra $(CFLAGS) -o imgdataopt.darwinc32 imgdataopt.c zlib_src/zall.c
...
imgdataopt.darwinc64: imgdataopt.c $(ZLIB_HEADERS) $(ZLIB_SRCS)
	$(DOCKER_CROSSBUILD) /usr/osxcross/bin/o64-clang -mmacosx-version-min=10.5 -Wl,-dead_strip -ffunction-sections -fdata-sections -lSystem -lcrt1.10.5.o -nostdlib -Izlib_src -DNO_VIZ -DNO_COMBINE64 -ansi -pedantic -O2 -W -Wall -Wextra $(CFLAGS) -o imgdataopt.darwinc64 imgdataopt.c zlib_src/zall.c
